...
class ProductTagsAll extends AbstractCondition implements ProductAll
{
    use ProductAllCheck;
    ...
    {
        return array(
            'product_tags' => WC_ADP_PLUGIN_VIEWS_PATH . 'conditions/products/product-tags.php',
        );
    }
}
