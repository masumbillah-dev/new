...
<tr valign="top">
    <th scope="row" class="titledesc"><?php esc_html_e('Round up totals to match modified item prices',
            'advanced-dynamic-pricing-for-woocommerce') ?></th>
    <td class="forminp forminp-checkbox">
        <fieldset>
            <legend class="screen-reader-text"><span><?php esc_html_e('Round up totals to match modified item prices',
