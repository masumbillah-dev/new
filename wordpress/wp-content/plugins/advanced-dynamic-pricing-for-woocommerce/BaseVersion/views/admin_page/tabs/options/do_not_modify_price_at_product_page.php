...
<tr valign="top">
    <th scope="row" class="titledesc"><?php esc_html_e('Don\'t modify product price on product page',
            'advanced-dynamic-pricing-for-woocommerce') ?></th>
    <td class="forminp forminp-checkbox">
        <fieldset>
            <legend class="screen-reader-text"><span><?php esc_html_e('Don\'t modify product price on product page',
