...
<div class="hero overlay inner-page bg-primary py-5">
    <div class="container">
        <div class="row align-items-center justify-content-center text-center pt-5">
            <div class="col-lg-6">
                <h1 class="heading text-white mb-3" data-aos="fade-up"><?php the_archive_title(); ?></h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row posts-entry">
            <div class="col-lg-8">
                ...
                <div class="blog-entry d-flex flex-column flex-md-row blog-entry-search-item">
                    <a href="<?php the_permalink(); ?>" class="img-link me-4 flex-shrink-0">
                        <img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="Image" class="img-fluid">
                    </a>
                    <div>
                        <span class="date"><?php echo get_the_date('j F Y'); ?> &bullet; <?php the_category(" | "); ?></span>
