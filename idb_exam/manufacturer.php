...
<h1>Add Manufacturer</h1>
    <form action="" method="post" style="width: 50%; background-color: #ffffff; padding: 20px; border-radius: 5px;">
        ...
        <?php 
         ...
         <tr>
            ...
            <td><form method="POST">
                ...
                <button type="submit" name="delete_btn" style="background-color: #ff4d4d; color: white; border-radius: 5px;">Delete</button>
            </form></td>
         </tr>
