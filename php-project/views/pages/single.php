   <?php
    $product = Product::productById($_GET['id']);
    echo "<pre>";
    print_r($product);
    echo "</pre";
               ...
               <div class="col-lg-7 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
                   <div class="row g-4 single-product">
                       <div class="col-xl-6">
                           <div class="single-carousel owl-carousel">
                               ...
                               <div class="single-item"
                                   data-dot="<img class='img-fluid' src='<?php echo BASE_URL; ?>admin/<?php echo $product['image'];?>' alt=''>">
                                   <div class="single-inner bg-light rounded">
                                       <img src="<?php echo BASE_URL; ?>admin/<?php echo $product['image'];?>" class="img-fluid rounded" alt="Image">
                                   </div>
                               </div>
                           </div>
                       </div>
                       <div class="col-xl-6">
                           ...
                           <p class="mb-3"><?php echo $product['category'];?></p>
