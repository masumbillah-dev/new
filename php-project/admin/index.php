...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo BASE_URL_ADMIN; ?>assets/img/user7-128x128.jpg"
                              alt="User Avatar"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo BASE_URL_ADMIN; ?>assets/img/user5-128x128.jpg"
                              alt="User Avatar"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo BASE_URL_ADMIN; ?>assets/img/user6-128x128.jpg"
                              alt="User Avatar"
                            />
    ...
    <script
      src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.7/dist<?php echo BASE_URL_ADMIN; ?>assets/js/bootstrap.min.js"
      crossorigin="anonymous"
    ></script>
    ...
    <!-- jsvectormap -->
    <script
      src="https://cdn.jsdelivr.net/npm/jsvectormap@1.5.3/dist<?php echo BASE_URL_ADMIN; ?>assets/js/jsvectormap.min.js"
