                    ...
                    <li className="nav-item dropdown d-none d-lg-block">
                        ...
                        {createOpen && (
                            ...
                            <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list show">
                                ...
                                {/* Contact */}
                                <a className="dropdown-item preview-item" href="contacts">
                                ...
                                {/* Company */}
                                <a className="dropdown-item preview-item" href="companies">
                                ...
                                {/* Deal */}
                                <a className="dropdown-item preview-item" href="deals">
